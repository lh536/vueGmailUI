        ...
        <table class="table-fixed w-full">
            ...
            <tbody class="bg-[#303030]">
                <tr class="flex flex-grow-0 group border-l-none border-t-none border-r-none border-b border-[#494949] text-[#6E6E6E] pr-4 cursor-pointer hover:text-white">
                    <!-- 2 ICONS -->
                    <td class="w-28 flex justify-center items-center -space-x-2 border-l-4 border-[#4D90F0]">
                        <!-- 2 DOTS & INPUT -->
                    ...
                    <!-- 2 SENDER -->
                    <td class="w-56 shrink-0 font-medium text-sm flex items-center text-white">
                        <span>Twitter</span>
                    </td>
                    <!-- 2 SUBJECT -->
                    <td class="whitespace-nowrap truncate font-medium text-sm flex items-center space-x-1 text-white">
                        <span class="bg-[#DDDDDD] text-[#6A6766] rounded-md font-normal text-sm px-1">Social</span>
                        <span class="truncate">HEY! @lh536 You have a new follower!</span>
                    </td>
                    <!-- 2 TIME & OPTIONS -->
                    <td class="font-medium text-sm flex items-center justify-end flex-grow group shrink-0 pl-10 hover:pl-0">
