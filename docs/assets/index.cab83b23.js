...
const _sfc_main = {
  name: "App",
  components: {
    GmailSamplePage: defineAsyncComponent(() => __vitePreload(() => import("./GmailSamplePage.ac6863ca.js"), true ? [] : void 0))
  }
};
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_gmail_sample_page = resolveComponent("gmail-sample-page");
  return openBlock(), createBlock(_component_gmail_sample_page);
}
...
export { _export_sfc as _, __vitePreload as a, createBaseVNode as b, createElementBlock as c, defineAsyncComponent as d, createVNode as e, openBlock as o, resolveComponent as r };
